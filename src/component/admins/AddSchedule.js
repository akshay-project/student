        ...
        <div><br /><b></b>
          ...
          <div style={{ float: "right" }}>
                <Link to='/viewschedule' >
                    <button type="button" className="btn btn-danger">View All Schedule</button>
                </Link>
            </div><br /><br />
                ...
                <tbody>
                    <tr>
                        <th colSpan="6"> < input value={datea}
                            onChange={e => setDate(e.target.value)} type="date" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Date" /></th>
                    </tr>
                    <tr>
                        <th scope="row">1</th>
